# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 00:52:29 2024
...
def runner():
    ...
    url_extractor = base_url.format('AppleVisionPro', start_date_value, end_date_value, api_key)
    print(url_extractor)
    ...
    for i in d['articles']:
        ...
        'source': [source['name']], 'author': author, 'urlToImage': urlToImage})], ignore_index=True)
